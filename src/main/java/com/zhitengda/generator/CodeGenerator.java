package com.zhitengda.generator;
...
public class CodeGenerator {
     ...
     * 数据库连结信息
     */
    private final String dbUrl = "jdbc:oracle:thin:@127.0.0.1:33578/yzad";
     ...
     * 项目名
     */
    private final String projectName = "WxServer";
    /**
     * 指定包名
     */
    private final String packageName = "com.zhitengda.generator";
    /**
     * 作者名
     */
     ...
     * 指定生成的表名
     */
    private final String[] tableNames = new String[]{"TAB_WX_ADDRESS"};

    /**
     * 项目路径
     */
    private final String path = "E:/idea-work/imwj/";
    ...
    private void atuoGenerator(DataSourceConfig dataSourceConfig, StrategyConfig strategyConfig, GlobalConfig config, PackageConfig packageConfig) {
        // 配置模板：设置是否生成controller、service、mapper等
